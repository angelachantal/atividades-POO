...
class PlanosPos(Planos):
    ...
    def set_vencimento(self, vencimento):
        try:
            ...
            return f"Vencimento da fatura alterada para: {self.__vencimento:%d/%m/%Y}\n"
        except ValueError:
    ...
    def __verificar_vencimento(self):
        if datetime.today() < self.__vencimento:
            ...
            raise ValueError(
                f"Fatura vencida!\nData do vencimento: {self.__vencimento:%d/%m/%Y}"
            )
    ...
    def calcular_custo(self, meses=1):
        ...
        return (
            ...
            f"- Valor da fatura durante {meses} meses: R$ {calculo:.2f}\n"
        )

    def consultar_status(self):
        self.__consumo_total = (
        ...
        return (
            ...
            f"- Total a pagar: R$ {self.__fatura:.2f}\n"
            f"- Vencimento: {self.__vencimento:%d/%m/%Y}\n"
        )
